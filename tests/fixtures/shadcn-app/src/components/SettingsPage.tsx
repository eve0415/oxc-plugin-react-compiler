                ...
                <AccordionItem value="keybindings">
                  ...
                  <AccordionContent value="keybindings">
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between"><span>Save</span><kbd>Ctrl+S</kbd></div>
                      <div className="flex justify-between"><span>Find</span><kbd>Ctrl+F</kbd></div>
                      <div className="flex justify-between"><span>Replace</span><kbd>Ctrl+H</kbd></div>
                      <div className="flex justify-between"><span>Format</span><kbd>Shift+Alt+F</kbd></div>
                    </div>
                  </AccordionContent>
                </AccordionItem>
